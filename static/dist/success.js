...
/***/ function(module, exports, __webpack_require__) {
	...
	var FileCard = (function (_React$Component) {
	    ...
	    function FileCard(props) {
	        ...
	        _get(Object.getPrototypeOf(FileCard.prototype), "constructor", this).call(this, props);
	    }
	    ...
	    _createClass(FileCard, [{
	        ...
	        value: function componentDidUpdate() {
	            ...
	            if (this.props.type === "binary") {
	                $(_react2["default"].findDOMNode(this.refs.play)).hide();
	            }
	        }
	    }, {
	        key: "render",
	                ...
	                _react2["default"].createElement(
	                    ...
	                    _react2["default"].createElement(
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: file_icon },
	                            _react2["default"].createElement("img", { src: this.props._TYPE_ICON_SRC[this.props.type] })
	                        ),
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "file-meta" },
	                            _react2["default"].createElement(
	                                "h2",
	                                { id: "filename", className: "filename" },
	                                this.props.filename
	                            ),
	                            _react2["default"].createElement(
	                                "span",
	                        ...
	                        _react2["default"].createElement(
	                            "div",
	                            { className: "p-link" },
	                            _react2["default"].createElement("input", { type: "text", readOnly: "true", value: this.props.url_s, id: "link_s" })
	                        ),
	                        _react2["default"].createElement(
	                            "div",
	                            { id: "action-area" },
	                            _react2["default"].createElement(
	                                "a",
	                                { href: this.props.url_d, id: "download-link" },
	                                "download"
	                            ),
	                            _react2["default"].createElement(
	                                "a",
	                                { ref: "play", href: playButtonHref, id: "play-link" },
	                                playButtonText
	                            )
	                        )
	                    )
	                ),
	                _react2["default"].createElement(ImageCard, { show_image_card: show_image_card, url_i: this.props.url_i,
	...
	var ImageCard = (function (_React$Component2) {
	    _inherits(ImageCard, _React$Component2);
	    ...
	    function ImageCard(props) {
	        ...
	        _get(Object.getPrototypeOf(ImageCard.prototype), "constructor", this).call(this, props);
	
	        this.onClick = function (event) {
	            var $preview = $(_react2["default"].findDOMNode(_this.refs.preview));
	            var $imageCard = $(_react2["default"].findDOMNode(_this.refs.imageCard));
	            var $qr_code = $(_react2["default"].findDOMNode(_this.refs.qrcode));
	            ...
	            _this.setState({ 'zoomed': !_this.state.zoomed });
	        };
	    ...
	    _createClass(ImageCard, [{
	        ...
	        value: function render() {
	            ...
	            return _react2["default"].createElement(
	                ...
	                _react2["default"].createElement(
	                    "div",
	                    { id: "image-card", className: this.props.show_image_card, ref: "imageCard" },
	                    _react2["default"].createElement(
	                        "div",
	                        { id: "image-preview", ref: "preview" },
	                        _react2["default"].createElement("img", { src: this.props.url_i, onClick: this.onClick, ref: "zoom" }),
	                        _react2["default"].createElement(
	                            "div",
	                            { id: "image-link", ref: "link" },
	                            _react2["default"].createElement("input", { readOnly: "true", type: "text", value: this.props.image_link_input })
	                        )
	                    )
	                ),
	                _react2["default"].createElement("img", { ref: "qrcode", className: "qrcode", src: qrURL, width: "150", height: "150" })
	            );
	        }
	    }]);
